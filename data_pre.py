# -*- coding: utf-8 -*-
"""
Created on Wed Nov  7 15:31:20 2018

@author: cc_privide
"""
import pandas as pd
import numpy as np
data=pd.read_csv('D:/ccwang20160302/python/titanic_test/data/train.csv')
...
data_pre=pd.concat([Pclass_dummies,sex_dummies,Em_dummies,SibSp_n,SibSp_y,
                    Parch_n,Parch_y,ticket_dig,ticket_str,fare_pre,new_age_df,new_cabin_df,data['Survived']],axis=1)
data_pre.to_csv('D:/ccwang20160302/python/titanic_test/firsttest/data_pre.csv')        